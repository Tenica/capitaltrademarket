...
const {updateAllUserInvestments, viewAllInvestments, viewUserInvestments, cronUpdateAll} = require('../controllers/investments');
...
router.get('/cron-payout', cronUpdateAll)
